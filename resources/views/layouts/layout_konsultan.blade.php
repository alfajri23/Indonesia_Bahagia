...
<head>
    ...
    <title>{{isset($title) ? $title : 'Konsultan Hallo bahagia';}}</title>
    <!-- Favicon icon -->
        ...
        ***********************************-->
        <div class="nav-header bg-white">
            <a href="{{route("homeAdmin")}}" class="brand-logo">
                ...
                <h4 class="brand-title text-primary fw-bold fs-3 mb-0">Konsultan</h4>
            </a>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="ai-icon" href="{{route('konsultanDetail')}}" aria-expanded="false">
                            <i class="la la-calendar"></i>
                            <span class="nav-text">Konsultasi Saya</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="ai-icon" href="{{route('pendaftaranKonsultasiKonsultan')}}" aria-expanded="false">
                            <i class="la la-calendar"></i>

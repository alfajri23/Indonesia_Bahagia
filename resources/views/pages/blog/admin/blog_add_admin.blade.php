...
<div class="container-fluid">
    <h2 class="text-center h1 font-weight-bold text-gray-800 mb-4">Tambah Blog</h2>
    <div class="row">
        <div class="col-9">
        ...
        <div class="col-3">
            ...
            <div class="form-group">
                ...
                <input type="file" name="gambar" id="exampleFormControlInput1" placeholder="" required>
            </div>

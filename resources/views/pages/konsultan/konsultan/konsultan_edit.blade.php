...
<div class="container-fluid">
    ...
    <div class="row">
        <h2 class="text-grey-700 fw-700 display1-size">Edit</h2>
    </div>
    ...
    <div class="row">
        ...
        @endif
        <div class="col-8">
            <form action="{{route('konsultanStore')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="p-3">
                <div class="mb-3">
        ...
        <div class="col-4">
            <div class="p-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="SIPP" value="{{$data->SIPP}}" class="form-control">
                </div>

                <div class="mb-3">
                    <label class="fw-700 text-grey-800 display2-md-size">STR</label>
                    <input type="text" name="STR"  value="{{$data->STR}}" class="form-control">
                </div>

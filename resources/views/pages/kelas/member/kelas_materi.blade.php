        ...
        <nav class="navigation scroll-bar">
            <div class="container pl-0 pr-0">
                <div class="nav-content">
                    <div class="nav-top">
                        <a href="/"><i class="feather-slack text-success display1-size mr-3 ml-3"></i><span class="d-inline-block fredoka-font ls-3 fw-600 text-current font-xl logo-text mb-0">Kelas</span> </a>
                            ...
                            <div class="card shadow-xss mb-0 w-100">
                                ...
                                <div id="collapse-{{$bab['id']}}" class="collapse p-3 show" aria-labelledby="headingOne" data-parent="#accordion">
                                    ...
                                    <div class="card-body d-flex p-2 align-items-center">
                                        ...
                                        <a href="{{route('enrollMateriKelas',['id'=>$id, 'ids'=>$bab->id])}}">
